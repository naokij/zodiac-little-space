...
export const scenes: Scene[] = [
  ...
  },
  {
    ...
    zone: 'space',
    zoneLabel: '小太空',
    desc: '金牛座和天秤座的家,围着矮矮的木栅栏,里面种着南瓜、胡萝卜和小蘑菇。这里的蔬菜白天睡觉,一到晚上就一个一个发出暖暖的光——那是月亮姐姐的小帮手星灵座,每晚提着月光洒水壶送来的。星灵座住在栅栏外的玻璃花房里,白天睡觉,月亮一出来就上班。第十集里,两个女孩在这里办了收获晚餐,用金色小天平称出了"心意和心意一样重";第十一集,角落里的花种子喝饱了月光,开成了一片发光的星星花。',
    image: '/assets/locations/月光农场.jpg',
    highlights: ['夜里发光的蔬菜', '金色小天平', '星星花圃', '星灵座的玻璃花房'],
