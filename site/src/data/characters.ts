...
export const characters: Character[] = [
  ...
  },
  {
    ...
    colorVar: 'var(--c-pink)',
    power: '"嗖"的一下 + 亮晶晶小水花',
    bio: '云螺座的妹妹,住在星星小溪另一头。金色的双马尾系着粉色蝴蝶结,戴小皇冠,穿白色小裙子,披粉色小披风,怀里抱着一只半透明的粉白小米虾。姐姐有多慢,妹妹就有多快——她跑起来"嗖"的一下,只剩一条亮亮的小水痕;吓一大跳的时候,会像小虾米一样倒着弹出去。她把整条小溪洗得亮晶晶,跑过的地方亮起一串小水花,和姐姐的云螺银线挨在一起,像小溪的两条围巾。第九集登场:生日那天,姐姐云壳里最大的一朵云变成云朵蹦蹦床送给了她;她还跟姐姐学会了慢慢走——慢慢走,才能看见萤火虫的小灯。',
