...
export const characters: Character[] = [
  ...
  },
  {
    ...
    colorVar: 'var(--c-sky)',
    power: '云宝宝 + 拴在栅栏上的大白云',
    bio: '白色头发扎两个圆圆小丸子、穿浅蓝色小裙子的女孩,住在月光农场上空——一朵拴在栅栏上的大白云里,像一个大大的气球,晚上跟着月亮慢慢飘。云上有她的云枕头、云被子,还有一个给云宝宝睡的小云窝。云宝宝是她从小养大的小云朵,有一张圆圆的脸,平时乖乖地跟在她身边,就是管不住嘴——最爱偷吃凉凉的、甜甜的月光,吃多了就鼓成小皮球,被挠痒痒会"咯咯咯"笑出一场发光的毛毛雨。云穗座温柔又有耐心,总替云宝宝道歉:"对不起对不起,它还小嘛。"第十二集登场:云宝宝偷吃月光挡住月亮,害得农场蔬菜都不亮了,她想出挠痒痒的办法,让云宝宝把月光"笑"成毛毛雨还给农场,还说好以后每晚带云宝宝散步,顺路给农场下毛毛雨。',
